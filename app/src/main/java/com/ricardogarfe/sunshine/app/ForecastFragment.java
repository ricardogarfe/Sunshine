...
public class ForecastFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            new FetchWeatherTask().execute(DUMMY_POSTALCODE);
        }
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            String[] forecastStrinArray = null;

            String postalCode = params[0];//"46001,ES";
            String format = "json";
            String units = "metric";
            int numDays = 14;
            ...
            try {
                forecastStrinArray = getWeatherDataFromJson(forecastJsonStr, numDays);
            } catch (JSONException e) {
                Log.e(LOG_TAG, e.getMessage(), e);
                e.printStackTrace();
            }

            return forecastStrinArray;
        }
